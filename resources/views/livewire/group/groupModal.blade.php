...
<div x-data="{ open: false }" 
     @open-sector-modal.window="open = true" 
    ...
    <div x-show="open" 
        ...
        <div @click.away="open = false"
            ...
            <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#6b82ff] to-transparent opacity-50"></div>
            ...
            <div class="relative z-10">
                <div class="text-center mb-8">
                    ...
                    <p class="text-[#82BDED] text-xs uppercase tracking-[0.2em] mt-2 opacity-70">
                        Define the coordinates for your new constellation
                    </p>
                </div>

                <form wire:submit="createSector" class="space-y-6">
                    <div>
                        <label for="name" class="block text-[10px] uppercase tracking-widest text-[#3d4a7a] font-bold mb-2 ml-1">
                            Sector Name
                        </label>
            ...
            <div class="absolute -bottom-10 -left-10 w-32 h-32 bg-[#6b82ff]/10 rounded-full blur-3xl pointer-events-none"></div>
        </div>
    </div>
</div>